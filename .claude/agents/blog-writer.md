...
|---|---|
| ~을 통해 | ~으로 / ~을 써서 / ~덕분에 |
| ~를 기반으로 | ~을 바탕으로 → 그냥 문장 재구성 |
| 이는 ~를 의미합니다 | 즉 ~ / 결국 ~ / 그 말은 ~ |
| ~이 발표되었습니다 | ~을 발표했다 |
| ~이 확인되었습니다 | ~을 확인했다 / ~인 것으로 나타났다 |
| 주목할 만합니다 | 눈에 띄는 건 / 특이한 점은 |
| 이러한 맥락에서 | 이런 상황에서 / 그런 배경에서 |
...
- 주어와 술어 사이의 수식절이 길면 문장을 나눈다.
- 뉴스 포스트도 사람이 쓴 글처럼 읽혀야 한다. "보도에 따르면..." 류의 기계적 도입부를 피하고, 사실을 직접 전달한다.
- 셀프 검토: 초안을 쓴 뒤, 위 금지 패턴을 한 번 더 검색해서 고친다.
