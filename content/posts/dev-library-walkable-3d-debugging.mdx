...
엄밀히 말해 버그라기보다 설계 실패였지만, 이후 모든 작업의 기조를 정했다. 해법은 새 기능이 아니라 비유였다. 도서관. 방은 주제, 책장은 피드, 책은 아티클. 사람에게는 각자의 방이 주어진다. 이 아이디어 하나가 그때까지 쌓아온 모든 렌더링 개선보다 사용성에 크게 기여했다. 건축은 떠다니는 라벨이 결코 하지 못하는 방식으로 어디로 갈지를 알려주기 때문이다.
