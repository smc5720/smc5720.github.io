...
category: "news"
tags: ["programming","webdev","discuss","productivity"]
...
여기서 흔히 나오는 반론이 있다. 근거는 git 히스토리에 속하니 커밋 메시지를 잘 쓰고 소스는 깨끗하게 유지하라는 것이다. 저자의 대답은 간단하다. 1년 넘은 파일에 `git log`를 한번 돌려 보라는 것이다.
